...
async function trf_in_fee(gl_rek_db_1, gl_jns_db_1, gl_amount_db_1, gl_rek_cr_1, gl_jns_cr_1, gl_amount_cr_1, trx_type, rrn, product_name) {
    // proses TRX
    if (trx_type == "TRX") {
        dracc = gl_rek_db_1;
        ...
        kdkoldr = "N"
        kdkolcr = "N"
        kdtrnbuku = KODE_TRN_BUKU_TRFINFEE
        depfrom = ""
        depto = ""
        ...
        if (jnsdracc == "1") {
            dracc = crac.substr(0, 7) + "10" + dracc
        } else {
            dracc = dracc
        }
